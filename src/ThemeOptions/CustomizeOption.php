...
class CustomizeOption {
    ...
    public static $sidebarNavSmallText = '';
    public static $footerSmallText = '';
    public static $sidebarNavFlatStyle = '';
    public static $sidebarNavLegecyStyle = '';
    public static $sidebarNavCompact = '';
